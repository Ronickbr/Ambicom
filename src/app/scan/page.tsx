...
^FO667,2^A0R,30,30^FB205,1,0,C^FD\${val(data.model || data.modelo)}^FS
^FO687,215^A0R,15,15^FB205,1,0,C^FDVOLTAGEM^FS
^FO667,215^A0R,30,30^FB205,1,0,C^FD\${val(data.voltage || data.tensao)}^FS
...
^FO485,75^BQN,2,4^FDQA,\${val(data.internal_serial)}^FS
^FO465,2^A0R,15,15^FB215,1,0,C^FDPNC/ML^FS
^FO445,2^A0R,30,30^FB215,1,0,C^FD\${val(data.pnc_ml)}^FS
^FO377,2^A0R,15,15^FB120,1,0,C^FDGAS FRIGOR.^FS
^FO355,2^A0R,22,22^FB120,1,0,C^FD\${val(data.refrigerant_gas || data.gas_refrigerante)}^FS
^FO377,112^A0R,15,15^FB120,1,0,C^FDCARGA GAS^FS
^FO355,112^A0R,22,22^FB120,1,0,C^FD\${val(data.gas_charge || data.carga_gas)}^FS
^FO287,2^A0R,15,15^FB120,1,0,C^FDVOL. FREEZER^FS
^FO265,2^A0R,22,22^FB120,1,0,C^FD\${val(data.volume_freezer)}^FS
^FO287,112^A0R,15,15^FB120,1,0,C^FDVOL. REFRIG.^FS
^FO265,112^A0R,22,22^FB120,1,0,C^FD\${val(data.volume_refrigerator)}^FS
^FO197,2^A0R,15,15^FB215,1,0,C^FDP. DE ALTA / P. DE BAIXA^FS
^FO173,2^A0R,18,18^FB215,1,0,C^FD\${val(data.pressure_high_low || data.pressao_alta_baixa)}^FS
^FO108,2^A0R,15,15^FB120,1,0,C^FDCORRENTE^FS
^FO86,2^A0R,22,22^FB120,1,0,C^FD\${val(data.electric_current || data.corrente_eletrica)}^FS
^FO108,112^A0R,15,15^FB120,1,0,C^FDPOT. DEGELO^FS
^FO86,112^A0R,22,22^FB120,1,0,C^FD\${val(data.defrost_power || data.potencia_degelo)}^FS
^FO10,225^A0N,15,15^FDNUMERO DE SERIE AMBICOM:^FS
^FO10,243^A0N,30,30^FD\${val(data.internal_serial)}^FS
^FO10,268^A0N,15,15^FD\${val(data.commercial_code || data.codigo_comercial)}^FS
^FO580,285^A0R,45,45^FB155,1,0,C^FD\${val(data.frequency || data.frequencia || '60 Hz')}^FS
^FO470,285^A0R,15,15^FB155,1,0,C^FDCOMPRESSOR^FS
^FO440,285^A0R,20,20^FB155,1,0,C^FD\${val(data.compressor)}^FS
^FO350,285^A0R,15,15^FB155,1,0,C^FDVOLUME TOTAL^FS
^FO320,285^A0R,30,30^FB155,1,0,C^FD\${formatTotalVolume(data.volume_freezer, data.volume_refrigerator, data.volume_total) || '-'}^FS
^FO230,285^A0R,15,15^FB155,1,0,C^FDCAPAC. CONG.^FS
^FO206,285^A0R,25,25^FB155,1,0,C^FD\${val(data.freezing_capacity || data.capacidade_congelamento)}^FS
^FO110,285^A0R,15,15^FB155,1,0,C^FDTAMANHO^FS
^FO86,285^A0R,30,30^FB155,1,0,C^FD\${data.size || data.tamanho ? String(data.size || data.tamanho).charAt(0).toUpperCase() : '-'}^FS
^XZ`.replace(/\n/g, '');
            } else {
                zplCode = `^XA
^PW440
...
^FO0,135^A0N,30,30^FB205,1,0,C^FD\${val(data.model || data.modelo)}^FS
^FO215,115^A0N,15,15^FB205,1,0,C^FDVOLTAGEM^FS
^FO215,135^A0N,30,30^FB205,1,0,C^FD\${val(data.voltage || data.tensao)}^FS
...
^FO55,185^BQN,2,4^FDQA,\${val(data.internal_serial)}^FS
^FO0,285^A0N,15,15^FB210,1,0,C^FDPNC/ML^FS
^FO0,310^A0N,30,30^FB210,1,0,C^FD\${val(data.pnc_ml)}^FS
^FO0,385^A0N,15,15^FB102,1,0,C^FDGAS FRIGOR.^FS
^FO0,410^A0N,22,22^FB102,1,0,C^FD\${val(data.refrigerant_gas || data.gas_refrigerante)}^FS
^FO107,385^A0N,15,15^FB102,1,0,C^FDCARGA GAS^FS
^FO107,410^A0N,22,22^FB102,1,0,C^FD\${val(data.gas_charge || data.carga_gas)}^FS
^FO0,485^A0N,15,15^FB102,1,0,C^FDVOL. FREEZER^FS
^FO0,510^A0N,22,22^FB102,1,0,C^FD\${val(data.volume_freezer)}^FS
^FO107,485^A0N,15,15^FB102,1,0,C^FDVOL. REFRIG.^FS
^FO107,510^A0N,22,22^FB102,1,0,C^FD\${val(data.volume_refrigerator)}^FS
^FO0,585^A0N,15,15^FB210,1,0,C^FDP. DE ALTA / P. DE BAIXA^FS
^FO0,615^A0N,18,18^FB210,1,0,C^FD\${val(data.pressure_high_low || data.pressao_alta_baixa)}^FS
^FO0,685^A0N,15,15^FB102,1,0,C^FDCORRENTE^FS
^FO0,710^A0N,22,22^FB102,1,0,C^FD\${val(data.electric_current || data.corrente_eletrica)}^FS
^FO107,685^A0N,15,15^FB102,1,0,C^FDPOT. DEGELO^FS
^FO107,710^A0N,22,22^FB102,1,0,C^FD\${val(data.defrost_power || data.potencia_degelo)}^FS
^FO222,770^A0B,15,15^FDNUMERO DE SERIE AMBICOM:^FS
^FO240,770^A0B,30,30^FD\${val(data.internal_serial)}^FS
^FO265,770^A0B,15,15^FD\${val(data.commercial_code || data.codigo_comercial)}^FS
^FO285,185^A0N,45,45^FB155,1,0,C^FD\${val(data.frequency || data.frequencia || '60 Hz')}^FS
^FO285,285^A0N,15,15^FB155,1,0,C^FDCOMPRESSOR^FS
^FO285,320^A0N,20,20^FB155,1,0,C^FD\${val(data.compressor)}^FS
^FO285,415^A0N,15,15^FB155,1,0,C^FDVOLUME TOTAL^FS
^FO285,445^A0N,30,30^FB155,1,0,C^FD\${formatTotalVolume(data.volume_freezer, data.volume_refrigerator, data.volume_total) || '-'}^FS
^FO285,545^A0N,15,15^FB155,1,0,C^FDCAPAC. CONG.^FS
^FO285,575^A0N,25,25^FB155,1,0,C^FD\${val(data.freezing_capacity || data.capacidade_congelamento)}^FS
^FO285,675^A0N,15,15^FB155,1,0,C^FDTAMANHO^FS
^FO285,705^A0N,30,30^FB155,1,0,C^FD\${data.size || data.tamanho ? String(data.size || data.tamanho).charAt(0).toUpperCase() : '-'}^FS
^XZ`.replace(/\n/g, '');
            }
