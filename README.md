...
Este projeto utiliza o versionamento semântico. A versão atual é **v2.11.8**, representando uma evolução significativa na arquitetura e funcionalidades do sistema original.
