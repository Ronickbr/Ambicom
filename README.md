...
Este projeto utiliza o versionamento semântico. A versão atual é **v2.10.11**, representando uma evolução significativa na arquitetura e funcionalidades do sistema original.
